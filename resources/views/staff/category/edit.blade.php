...
@section('content')
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-2" style="text-decoration: underline">Edit Data Kategori</h1>
                        ...
                        <form class="p-10 bg-white rounded shadow-xl" method="POST"
                            ...
                            <div class="mt-2">
                                ...
                                <input class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="name"
                                    name="name" type="name" required placeholder="Nama Kategori"
                                    aria-label="name" value="{{ $categories->name }}">
                            </div>
                            <div class="mt-6">
