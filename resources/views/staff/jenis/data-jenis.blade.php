...
@section('content')
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="text-3xl text-black pb-5" style="text-decoration: underline">Data Jenis</h1>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
                ...
                <a href="/create-jenis" class="hover:text-blue-500">
                    <p class="text-md pb-3 flex items-center ml-5 text-green-700 underline">
                        <i class="fa fa-plus mr-3 text-green-700"></i> Tambah Data Jenis
                    </p>
                </a>
                    ...
                    <tbody>
                        @foreach ($jeniss as $item)
                            <tr
                                ...
                                <form action="{{ route('jenis.edit', ['id' => $item->id]) }}">
                                    <td class="px-6 py-4">
                                ...
                                <form action="{{ route('jenis.delete', ['id' => $item->id]) }}">
                                    <td class="px-6 py-4">
